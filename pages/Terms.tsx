  ...
  return (
    <div className="bg-white dark:bg-gray-900 p-8 rounded-lg shadow-sm max-w-4xl mx-auto border border-gray-100 dark:border-gray-800">
      ...
      <div className="space-y-6 text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">3. Loan Terms & Repayment</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">4. Critical Verification</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">7. Modifications</h2>
        ...
        <div className="pt-8 border-t border-gray-100 dark:border-gray-800">
          <p className="text-xs text-gray-500 dark:text-gray-400">Last Updated: June 2025</p>
        </div>
      </div>
